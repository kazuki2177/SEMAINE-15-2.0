    ...
    <div class="container">
        ...
        <form name="Détail produit" id="Détail produit">
            <div class="form-group">
                ...
                <label for="nomProduit">Catégorie :</label><input type="text" class="form-control" name="nomProduit" id="nomProduit" value="<?php echo $produit->cat_nom ?>">
                <label for="pro_libelle">Libéllé produit :</label><input type="text" class="form-control" name="pro_libelle" id="pro_libelle" value="<?php echo $produit->pro_libelle ?>">
